...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val google_sign_in_button: android.widget.Button = findViewById(R.id.google_singin_button)
        google_sign_in_button.setOnClickListener {
            // First step
            googleLogin()
        }
        val facebook_login_button: android.widget.Button = findViewById(R.id.facebook_login_button)
